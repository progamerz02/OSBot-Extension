...
const DirectMessage = (function () {
  ...
  async function compose(recipient, subject, message) {
    ...
    return rawCompose(
      encodeURIComponent(formatRecipient(recipient)),
  ...
  function rawCompose(
    ...
    return send({
      ...
      data: `form_submitted=1&csrfKey=${csrfKey}&MAX_FILE_SIZE=${maxFileSize}&plupload=${plUpload}&messenger_to_original${messengerToOriginal}=&messenger_to=${recipient}&messenger_title=${subject}&messenger_content=${message}`,
    });
  }
